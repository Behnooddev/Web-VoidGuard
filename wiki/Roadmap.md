...
| 2 | Process monitoring, open ports (+ terminate/open/close), network interfaces, service monitoring | 🔶 In progress — process + ports done, [handoff](https://github.com/OWNER/voidguard/blob/main/handoffs/02-phase-2-handoff.md); network adapters + services remaining |
